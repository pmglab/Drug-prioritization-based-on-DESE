...
#get approved or investigational drugs' names. Information can be acessed from DrugBank using r package 'dbparser'(https://cran.r-project.org/web/packages/dbparser/vignettes/dbparser.html)
drugbank_table = pd.read_table("/home/lxy/03Drug_Reposition/research/gene_selective/level3_drug_perturb_expr/code/drugbank_drugName_group.txt",sep="\t")
...
inst = pd.read_csv("/home/lxy/03Drug_Reposition/resourceData/LINCS/GSE92742_Broad_LINCS_inst_info.txt",sep="\t")
...
qc_info = pd.read_table("/home/lxy/03Drug_Reposition/resourceData/LINCS/GSE92742_Broad_LINCS_sig_metrics.txt",sep="\t")
...
cell_expr = parse("/home/lxy/03Drug_Reposition/resourceData/LINCS/GSE92742_Broad_LINCS_Level3_INF_mlr12k_n1319138x12328.gctx",cid=high_qual_inst_cp.inst_id)
...
ctrl_expr = parse("/home/lxy/03Drug_Reposition/resourceData/LINCS/GSE92742_Broad_LINCS_Level3_INF_mlr12k_n1319138x12328.gctx",cid=ctrl_high.inst_id)
...
gene_info=pd.read_table("/home/lxy/03Drug_Reposition/resourceData/LINCS/GSE92742_Broad_LINCS_gene_info.txt",sep="\t")
